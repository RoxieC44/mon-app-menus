...
const DEFAULT_RECIPES = [
  ...
  { id: '3', name: 'Dhal de lentilles et riz basmati', carb: 'Riz', equipment: 'Thermomix', season: 'Toutes', type: 'link', url: 'https://www.marmiton.org/recettes/recette_dhal-de-lentilles-corail_345759.aspx', ingredients: ['250g de lentilles corail', '200g de riz basmati', '400ml de lait de coco', 'Curry', '1 oignon'], category: 'repas' },
  { id: '4', name: 'Poulet rôti et frites maison au double tiroir', carb: 'Pommes de terre', equipment: 'Ninja Double Stack', season: 'Toutes', type: 'text', instructions: 'Disposer les morceaux de poulet assaisonnés dans le tiroir du haut et les frites de patates douces ou de pdt dans le tiroir du bas. Lancer la cuisson synchronisée à 200°C pendant 25 min.', ingredients: ['800g de pommes de terre', '4 cuisses ou filets de poulet', 'Huile d\'olive', 'Paprika', 'Herbes de Provence'], category: 'repas' },
  ...
  { id: '10', name: 'Velouté de légumes de saison', carb: 'Pommes de terre', equipment: 'Thermomix', season: 'Hiver', type: 'text', instructions: 'Mettre les légumes et les pommes de terre dans le bol avec l\'eau et le bouillon. Cuire 20 min à 100°C vitesse 1, puis mixer 1 min vitesse 10.', ingredients: ['1 kg de légumes variés', '2 pommes de terre', '800ml d\'eau', '1 cube de bouillon', '20cl de crème'], category: 'repas' },
  ...
  { id: '12', name: 'Cordon bleu et Pommes de terre', carb: 'Pommes de terre', equipment: 'Ninja Double Stack', season: 'Toutes', type: 'text', instructions: 'Placer les cordons bleus dans un tiroir et les pommes de terre sautées dans l\'autre. Cuisson synchronisée 18 min à 200°C.', ingredients: ['4 cordons bleus', '600g de pommes de terre en dés', 'Huile d\'olive', 'Épices'], category: 'repas' },
