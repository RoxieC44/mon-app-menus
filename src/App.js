...
const INITIAL_EQUIPMENTS = ['Thermomix', 'Cookeo', 'Ninja Double Stack', 'Poêle', 'Four', 'Casserole', 'Gaufrier - Croque-Monsieur - Panini', 'Crêpière - Mini woks - Grill', 'Raclette - Pierrade - Fondue', 'Plancha', 'Barbecue', 'Sans Cuisson'];
        ...
        {recipe.ingredients && recipe.ingredients.length > 0 && (
          <div>
            ...
            <ul className="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-1.5">
              {recipe.ingredients.join(', ') && recipe.ingredients.map((ing, idx) => (
